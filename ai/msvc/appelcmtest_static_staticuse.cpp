...
SCF_USE_STATIC_PLUGIN(addon_ruledef)
SCF_USE_STATIC_PLUGIN(addon_lootloader)
SCF_USE_STATIC_PLUGIN(addon_dynworldload)
SCF_USE_STATIC_PLUGIN(lootmgr)
...
SCF_USE_STATIC_PLUGIN(rulebase)
SCF_USE_STATIC_PLUGIN(stdphyslayer)
SCF_USE_STATIC_PLUGIN(xmlpersist)
SCF_USE_STATIC_PLUGIN(ui_inventory)
SCF_USE_STATIC_PLUGIN(ui_inventory2)
