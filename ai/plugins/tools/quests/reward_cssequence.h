...
#ifndef __CEL_TOOLS_QUESTS_REWARD_CSSEQUENCE__
#define __CEL_TOOLS_QUESTS_REWARD_CSSEQUENCE__
 ...
 * This reward type listens to the name 'cel.questreward.cssequence'.
 */
CEL_DECLARE_REWARDTYPE(CsSequence,"cel.questreward.cssequence")

/**
 * The 'cssequence' reward factory.
 */
class celCsSequenceRewardFactory : public scfImplementation2<
	celCsSequenceRewardFactory, iQuestRewardFactory,
...
class celCsSequenceReward : public scfImplementation1<
	celCsSequenceReward, iQuestReward>
{
private:
  celCsSequenceRewardType* type;
  csString sequence;
