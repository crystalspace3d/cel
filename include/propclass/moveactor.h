...
#ifndef __CEL_PF_MOVEACTOR__
#define __CEL_PF_MOVEACTOR__

#include "cstypes.h"
#include "csutil/scf.h"

namespace iPcmMoveActor
{
...
struct Analog : public virtual General
{
};
} // iPcmMoveActor
 ...
 */
struct iPcMoveActor : public virtual iBase
{
  SCF_INTERFACE (iPcMoveActor, 0, 0, 1);
