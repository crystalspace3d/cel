...
SOURCE="$(InputPath)"
PostBuild_Cmds=echo Moving output to CEL root.	copy $(TargetPath)  ..	copy ..\plugins\behaviourlayer\python\plpython.csplugin  ..
...
SOURCE=..\plugins\behaviourlayer\python\plpython.csplugin
# End Source File
