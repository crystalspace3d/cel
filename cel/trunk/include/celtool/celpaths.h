...
#ifndef __CEL_CELTOOL_CELPATHS_H__
#define __CEL_CELTOOL_CELPATHS_H__
...
namespace CEL
{
   ...
   * contain CEL-related resources, plugins as well as common data and
   ...
   */
  CEL_CELTOOL_EXPORT csPathsList* GetPlatformInstallationPaths ();
} // namespace CEL

#endif // __CEL_CELTOOL_CELPATHS_H__
