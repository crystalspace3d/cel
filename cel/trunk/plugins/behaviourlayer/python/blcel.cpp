...
static PyObject *_wrap_iPcMeshSelect_SetMaxSelectionDistance(PyObject *, PyObject *args) {
    ...
    if (SWIG_arg_fail(1)) SWIG_fail;
    {
        arg2 = (uint const)(SWIG_As_unsigned_SS_int(obj1)); 
        if (SWIG_arg_fail(2)) SWIG_fail;
    }
