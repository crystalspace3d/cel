 ...
 */
class celDebugPrintRewardType : public iQuestRewardType
{
public:
  iObjectRegistry* object_reg;

public:
  celDebugPrintRewardType (iObjectRegistry* object_reg);
  virtual ~celDebugPrintRewardType ();

  SCF_DECLARE_IBASE;

  virtual const char* GetName () const
  {
    return "cel.questreward.debugprint";
  }
