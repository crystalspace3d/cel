...
class iPcMechanicsJoint(cspace.iBase):
    ...
    def __init__(self): raise RuntimeError, "No constructor defined"
    def __repr__(self):
        return "<C iPcMechanicsJoint instance at %s>" % (self.this,)
...
class iCelInventorySpaceSlot(cspace.iBase):
    ...
    def __init__(self): raise RuntimeError, "No constructor defined"
    def __repr__(self):
        return "<C iCelInventorySpaceSlot instance at %s>" % (self.this,)
...
class iCelInventorySpace(cspace.iBase):
    ...
    def __init__(self): raise RuntimeError, "No constructor defined"
    def __repr__(self):
        return "<C iCelInventorySpace instance at %s>" % (self.this,)
...
class iPcSoundListener(cspace.iBase):
    ...
    def __init__(self): raise RuntimeError, "No constructor defined"
    def __repr__(self):
        return "<C iPcSoundListener instance at %s>" % (self.this,)
...
class iPcSoundSource(cspace.iBase):
    ...
    def __init__(self): raise RuntimeError, "No constructor defined"
    def __repr__(self):
        return "<C iPcSoundSource instance at %s>" % (self.this,)
...
class iPcPropertyListener(cspace.iBase):
    ...
    def __init__(self): raise RuntimeError, "No constructor defined"
    def __repr__(self):
        return "<C iPcPropertyListener instance at %s>" % (self.this,)
...
class iPcProperties(cspace.iBase):
    ...
    def __init__(self): raise RuntimeError, "No constructor defined"
    def __repr__(self):
        return "<C iPcProperties instance at %s>" % (self.this,)
...
class iPcHover(cspace.iBase):
    ...
    def __init__(self): raise RuntimeError, "No constructor defined"
    def __repr__(self):
        return "<C iPcHover instance at %s>" % (self.this,)
...
class iPcCraftController(cspace.iBase):
    ...
    def __init__(self): raise RuntimeError, "No constructor defined"
    def __repr__(self):
        return "<C iPcCraftController instance at %s>" % (self.this,)
