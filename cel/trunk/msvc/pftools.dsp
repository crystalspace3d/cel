# Microsoft Developer Studio Project File - Name="pftools" - Package Owner=<4>
...
!MESSAGE 
!MESSAGE "pftools - Win32 Release" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "pftools - Win32 Debug" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE 
...
# PROP Output_Dir "release\temp\pftools"
# PROP Intermediate_Dir "release\temp\pftools"
# PROP Ignore_Export_Lib 0
# PROP Target_Dir ""
# ADD BASE CPP /nologo /MT /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "PFTOOLS_EXPORTS" /YX /FD /c
...
TargetPath=.\release\temp\pftools\pftools.dll
SOURCE="$(InputPath)"
...
# PROP Output_Dir "debug\temp\pftools"
# PROP Intermediate_Dir "debug\temp\pftools"
# PROP Ignore_Export_Lib 0
# PROP Target_Dir ""
# ADD BASE CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "PFTOOLS_EXPORTS" /YX /FD /GZ /c
...
# Begin Special Build Tool
TargetPath=.\debug\temp\pftools\pftools.dll
SOURCE="$(InputPath)"
PostBuild_Cmds=echo Moving output to CEL root.	copy $(TargetPath)  ..
# End Special Build Tool
