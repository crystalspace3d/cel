...
CFG=plgpfbillboard - Win32 Debug
...
!MESSAGE 
!MESSAGE NMAKE /f "plgpfbillboard.mak" CFG="plgpfbillboard - Win32 Debug"
!MESSAGE 
...
# PROP Output_Dir "release\temp\plgpfbillboard"
# PROP Intermediate_Dir "release\temp\plgpfbillboard"
...
# ADD RSC /l 0x409 /d "NDEBUG" /fo".\release\temp\plgpfbillboard\plgpfbillboard.res"
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 user32.lib gdi32.lib advapi32.lib /nologo /subsystem:windows /dll /machine:I386
# ADD LINK32 shell32.lib user32.lib gdi32.lib advapi32.lib delayimp.lib libcstool.lib libcsgfx.lib libcsgeom.lib libcsutil.lib libcstool.lib libcsgfx.lib libcsgeom.lib libcsutil.lib  /nologo /version:4.0 /subsystem:windows /dll /machine:I386 /out:"release\temp\plgpfbillboard\pfbillboard.dll"  /OPT:NOREF
# Begin Special Build Tool
TargetPath=".\release\temp\plgpfbillboard\pfbillboard.dll"
SOURCE="$(InputPath)"
...
# PROP Output_Dir "debug\temp\plgpfbillboard"
# PROP Intermediate_Dir "debug\temp\plgpfbillboard"
# PROP Ignore_Export_Lib 1
# PROP Target_Dir ""
...
# ADD RSC /l 0x409 /d "_DEBUG" /d "CS_DEBUG" /fo".\debug\temp\plgpfbillboard\plgpfbillboard.res"
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 user32.lib gdi32.lib advapi32.lib /nologo /subsystem:windows /dll /debug /machine:I386 /pdbtype:sept
# ADD LINK32 shell32.lib user32.lib gdi32.lib advapi32.lib delayimp.lib libcstool_d.lib libcsgfx_d.lib libcsgeom_d.lib libcsutil_d.lib  /nologo /version:1.0 /subsystem:windows /dll /profile /debug /machine:I386 /out:"debug\temp\plgpfbillboard\pfbillboard.dll" 
# SUBTRACT LINK32 /profile
# Begin Special Build Tool
TargetPath=".\debug\temp\plgpfbillboard\pfbillboard.dll"
SOURCE="$(InputPath)"
PostBuild_Cmds=echo Moving output to build root.	copy "$(TargetPath)" ..
# End Special Build Tool
