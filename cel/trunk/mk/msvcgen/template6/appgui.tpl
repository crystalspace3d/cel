...
# ADD LINK32 libcsutil.lib libcstool.lib libcsgeom.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib delayimp.lib %libs% %delaylibs% /nologo /subsystem:windows /machine:I386 /nodefaultlib:"LIBCMTD" /nodefaultlib:"LIBCMT" %lflags%
