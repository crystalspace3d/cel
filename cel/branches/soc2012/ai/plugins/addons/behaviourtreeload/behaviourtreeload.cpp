...
bool celAddOnBehaviourTreeLoader::ParseFactory (iDocumentNode* node)
{
...
bool celAddOnBehaviourTreeLoader::WriteBodies (iDocumentNode* factNode, iDynamicFactory* fact)
{
  float mass = 0.0f;
...
bool celAddOnBehaviourTreeLoader::WriteJoints (iDocumentNode* factNode, iDynamicFactory* fact)
{
...
bool celAddOnBehaviourTreeLoader::WriteDown (iBase* obj, iDocumentNode* parent,
