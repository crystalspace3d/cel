...
#ifndef __CEL_PF_HOVERCRAFTMOVEFACT__
#define __CEL_PF_HOVERCRAFTMOVEFACT__
...
/**
 * Factory for hover movement class.
 */
CEL_DECLARE_FACTORY (HoverCraftMove)

/**
 * This is a property class for hover movement.
 */
class celPcHoverCraftMove : public scfImplementationExt1<
	celPcHoverCraftMove, celPcCommon, iPcHoverCraftMove>
{
private:
  ...
  csWeakRef<iPcHover> pchover;
  csWeakRef<iPcCraftController> pccraft;
  csWeakRef<iPcDefaultCamera> pcdefcamera;
  void GetPCS ();

public:
  celPcHoverCraftMove (iObjectRegistry* object_reg);
  virtual ~celPcHoverCraftMove ();
...
#endif // __CEL_PF_HOVERCRAFTMOVEFACT__
